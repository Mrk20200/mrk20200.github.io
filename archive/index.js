addEventListener("DOMContentLoaded", () => {
    document.querySelectorAll("sb-project").forEach((element) => {
        ...
        if (parts) {
            element.innerHTML += ` (<a href="player.html?file=${file}.json">Play</a> | <a href="https://turbowarp.org/editor?project_url=https://raw.githubusercontent.com/Mrk20200/scratch-archive/main/${file}.json">Edit</a> | <a href="#${file}" onclick="downloadParts(${parts}, 'https://raw.githubusercontent.com/Mrk20200/scratch-archive/main/${file}', '${filename}');">Download*</a>)`;
        } else {
            element.innerHTML += ` (<a href="player.html?file=${file}.sb3">Play</a> | <a href="https://turbowarp.org/editor?project_url=https://raw.githubusercontent.com/Mrk20200/scratch-archive/main/${file}.sb3">Edit</a> | <a href="https://raw.githubusercontent.com/Mrk20200/scratch-archive/main/${file}.sb3">Download</a>)`;
        }
    });
});
